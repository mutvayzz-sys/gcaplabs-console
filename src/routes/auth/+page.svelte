...
<div class="w-full h-screen max-h-[100dvh] relative overflow-hidden headmaster-auth-bg" id="auth-page">
	...
	{#if loaded}
		<div
			class="fixed bg-transparent min-h-screen w-full flex items-center justify-center font-primary z-50 text-black dark:text-white"
			id="auth-container"
		>
			<div class="w-full px-6 min-h-screen flex flex-col text-center">
				...
				{:else}
					<div class="my-auto flex flex-col justify-center items-center">
						<div
							id="auth-login-card"
							class="headmaster-auth-card sm:max-w-md my-auto w-full rounded-[2rem] border border-white/70 px-8 py-9 dark:border-white/10 dark:text-gray-100"
						>
							<div class="mb-7 flex flex-col items-center">
								<HeadmasterMark className="size-16" />
								<div class="headmaster-sidebar-brand mt-4 text-sm font-semibold text-gray-950 dark:text-white">
									Headmaster
								</div>
							...
							>
								...
								<div class="mt-5">
									{#if $config?.features.enable_login_form || $config?.features.enable_ldap || form}
										{#if mode === 'ldap'}
											<button
												class="headmaster-primary-button transition w-full rounded-2xl font-semibold text-sm py-3"
												type="submit"
											>
												{$i18n.t('Authenticate')}
											</button>
							...
							{#if Object.keys($config?.oauth?.providers ?? {}).length > 0}
								...
								<div class="flex flex-col space-y-2">
									{#if $config?.oauth?.providers?.google}
										<button
											class="headmaster-secondary-button flex justify-center items-center transition w-full rounded-2xl font-medium text-sm py-3"
											on:click={() => {
		...
		{#if !$config?.metadata?.auth_logo_position}
			<div class="fixed left-8 top-8 z-50">
