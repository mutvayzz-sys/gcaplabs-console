				...
				>
					...
					>
						<div class=" self-center flex items-center justify-center size-9">
							<HeadmasterMark className="sidebar-new-chat-icon size-6 rounded-full group-hover:hidden" />
...
{#if $showSidebar}
	<div
		...
		id="sidebar"
		class="h-screen max-h-[100dvh] min-h-screen select-none headmaster-openwebui-shell {$showSidebar
		...
		>
			...
			>
				<a
					...
					aria-label="Headmaster home"
				>
					<HeadmasterMark className="size-7" />
				</a>

				<a href="/" class="flex flex-1 px-0.5" on:click={newChatHandler}>
					<div id="sidebar-webui-name" class="self-center font-primary leading-none">
						<div class="headmaster-sidebar-brand text-[0.68rem] font-semibold text-gray-950 dark:text-white">
							Headmaster
						</div>
